...
export class Expr<T> 
{
  ...
  public is(a1: any, a2?: any): Expr<boolean> {
    if (a2 === undefined) {
      return new ConditionUnary(a1, this);
    } else {
  ...
  public isNull(): Expr<boolean> {
    return new ConditionUnary('NULL', Expr.parse(this));
  }
  public isNotNull(): Expr<boolean> {
    return new ConditionUnary('NOT NULL', Expr.parse(this));
  }
  public isTrue(): Expr<boolean> {
    return new ConditionUnary('TRUE', Expr.parse(this));
  }
  public isFalse(): Expr<boolean> {
    return new ConditionUnary('FALSE', Expr.parse(this));
  }

import { Name, ObjectFromSelects, Selects, SourceInstanceFromSelects } from '../../_Types';
...
export class SourceQuery<A extends Name, S extends Selects> extends SourceBase<A, SourceInstanceFromSelects<S>> 
{
  ...
  public constructor(
    alias: A,
    public query: QuerySelectBase<any, S, ObjectFromSelects<S>[]>
  ) {
    super( alias );
  ...
  public getExpr(): Expr<ObjectFromSelects<S>[]> {
    return this.query;
  }
